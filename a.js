            ...
            function getAdBlockDiv() {
                ...
                if (playerRootDiv != null) {
                    ...
                    if (adBlockDiv == null) {
                        ...
                        adBlockDiv.innerHTML = '<div class="player-adblock-notice" style="color: black; background-color: rgba(0, 0, 0, 0.8); position: absolute; top: 0px; left: 0px; padding: 0px;"><p></p></div>';
                        adBlockDiv.style.display = 'none';
